\begin{filecontents*}{references.bib}
	...
	@article{famaey_mcgaugh_2012_lrr,
...
@article{milgrom1983_mond,
  ...
  year={1983}, volume={270}, pages={365--370},
  doi={10.1086/161130}
}
  ...
  journal={Physical Review D},
  year={2004}, volume={70}, pages={083509},
...
% typographic
\newcommand{\TF}{Tully--Fisher} % will render as Tully–Fisher under modern engines
...
\keybox{\textbf{Single-field statement.}\; I compute one scalar potential $\Phi_{\rm eff}$ from baryons and use it for both kinematics and lensing. Stars trace $-\nabla\Phi_{\rm eff}$. For lensing I form the \emph{total} density $\rho_{\rm tot} \equiv \nabla^2\Phi_{\rm eff}/(4\pi G)$ and project it to $\Sigma$ and $\Delta\Sigma$ (App.~\ref{app:lensing}); the diagnostic decomposition $\rho_{\rm eff}\equiv \rho_{\rm tot}-\rho_b$ is reported but not used for the prediction.}
